...
foreach($_SESSION['cart'] as $item) {
	echo '<tr>
			...
			<td><button class="btn btn-danger" onclick="updateCart('.$item['id'].', 0)">Delete</button></td>
		</tr>';
}
?>
		</table>
		<a href="checkout.php"><button class="btn btn-success" style="border-radius: 0px; font-size: 26px;">CONTINUE TO PAYMENT</button></a>
	</div>
</div>
