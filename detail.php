	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul style="display: flex; list-style-type: none; margin: 0px; padding: 0px;">
				...
				<li style="margin-left: 20px; border-left: solid #dad7d7 1px; font-size: 13pt; padding-top: 3px; padding-left: 20px;">7,635 Sold</li>
				</ul>
			...
			<button class="btn btn-secondary" style="margin-top: 20px; width: 100%; border-radius: 0px; font-size: 30px; background-color: #edebeb; border: solid #edebeb 1px; color: black;">
				<i class="bi bi-bookmark-heart-fill"></i> ADD TO FAVOURITE
			</button>
		</div>
...
<div class="container" style="margin-top: 20px; margin-bottom: 20px;">
	<h1 style="text-align: center; margin-top: 20px; margin-bottom: 20px;">YOU MAY INTEREST</h1>
	<div class="row">
	<?php
