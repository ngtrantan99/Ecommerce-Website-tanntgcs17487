...
<body style="background-image: url(../../assets/photos/a.jpg); background-size: cover; background-repeat: no-repeat;">
	<div class="container">
		<div class="panel panel-primary" style="width: 480px; margin: 0px auto; margin-top: 50px; background-color: white; padding: 10px; border-radius: 5px; box-shadow: 2px 2px #9ac9f5;">
			...
			<div class="panel-body">
				<form method="post" onsubmit="return validateForm();">
					...
					<div class="form-group">
					  <label for="confirmation_pwd">Re-password:</label>
					  <input required="true" type="password" class="form-control" id="confirmation_pwd" minlength="6">
					</div>
					<p>
						<a href="login.php">Already register? Log in here!</a>
					</p>
...
<script type="text/javascript">
	function validateForm() {
		...
		if($pwd != $confirmPwd) {
			alert("Re-password not correct. please input again")
			return false
		}
		return true
	}
